...
- [ ] Kitty terminal sessions https://github.com/jdholtz/i3-restore/issues/14 ([for not you can do it manually](https://sw.kovidgoyal.net/kitty/overview/#startup-sessions))
